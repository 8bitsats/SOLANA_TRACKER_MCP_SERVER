      ...
      try {
        switch (request.params.name) {
          case 'get_token_information': {
            const { tokenAddress } = request.params.arguments as { tokenAddress: string };
            try {
          ...
          case 'get_token_information_by_pool': {
            const { poolAddress } = request.params.arguments as { poolAddress: string };
            try {
          ...
          case 'get_tokens_created_by_wallet': {
            const { wallet } = request.params.arguments as { wallet: string };
            try {
          ...
          case 'search_tokens': {
            const { query, page, limit, sortBy, sortOrder, showAllPools, minCreatedAt, maxCreatedAt, minLiquidity, maxLiquidity, minMarketCap, maxMarketCap, minBuys, maxBuys, minSells, maxSells, minTotalTransactions, maxTotalTransactions, lpBurn, market, freezeAuthority, mintAuthority, deployer, showPriceChanges } = request.params.arguments as { query: string, page?: number, limit?: number, sortBy?: string, sortOrder?: string, showAllPools?: string, minCreatedAt?: number, maxCreatedAt?: number, minLiquidity?: number, maxLiquidity?: number, minMarketCap?: number, maxMarketCap?: number, minBuys?: number, maxBuys?: number, minSells?: number, maxSells?: number, minTotalTransactions?: number, maxTotalTransactions?: number, lpBurn?: number, market?: string, freezeAuthority?: string, mintAuthority?: string, deployer?: string, showPriceChanges?: boolean };
            try {
          ...
          case 'get_trending_tokens_timeframe': {
            const { timeframe } = request.params.arguments as { timeframe: string };
            try {
